...
AboutModule = __decorate([
    core_1.NgModule({
        imports: [platform_browser_1.BrowserModule, common_1.CommonModule, main_navigation_menu_module_1.MainNavigationMenuModule, about_routing_module_1.AboutRoutingModule],
